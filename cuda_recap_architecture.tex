...
Note that from the programmer's viewpoint, the threads are strictly partitioned in blocks. 
...
Therefore it would be \texit{nice} that they access adjacent memory addresses. This notion 
